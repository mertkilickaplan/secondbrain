...
export default function LoginPage() {
    ...
    const [errorAction, setErrorAction] = useState<'signin' | 'google' | 'reset-password' | 'retry' | null>(null);
        ...
        if (isSignUp) {
            ...
            if (error) {
                ...
                if (data.user && data.user.identities && data.user.identities.length === 0) {
                    ...
                    setSuggestion("Try signing in instead, or use 'Continue with Google' if you registered with Google.");
