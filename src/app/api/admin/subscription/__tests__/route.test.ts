...
describe("/api/admin/subscription", () => {
  ...
  describe("POST (Upgrade/Downgrade)", () => {
    it("should upgrade user to premium with valid admin key", async () => {
      ...
      const req = createRequest({ userId: mockUserId, action: "upgrade" }, validAdminKey);
    ...
    it("should downgrade user to free with valid admin key", async () => {
      ...
      const req = createRequest({ userId: mockUserId, action: "downgrade" }, validAdminKey);
    ...
    it("should reject with invalid admin key", async () => {
      const req = createRequest({ userId: mockUserId, action: "upgrade" }, "invalid-key");
    ...
    it("should reject invalid action", async () => {
      const req = createRequest({ userId: mockUserId, action: "invalid" }, validAdminKey);
