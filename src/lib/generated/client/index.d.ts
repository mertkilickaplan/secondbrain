...
export namespace Prisma {
  ...
  */
  ...
  > = {
    meta: {
      modelProps: "note" | "edge" | "userSubscription";
   ...
   * NoteCountOutputType without action
   */
  export type NoteCountOutputTypeCountOutgoingEdgesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
   ...
   * NoteCountOutputType without action
   */
  export type NoteCountOutputTypeCountIncomingEdgesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: EdgeWhereInput;
  };
  ...
  export type NoteSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    outgoingEdges<T extends Note$outgoingEdgesArgs<ExtArgs> = {}>(
      args?: Subset<T, Note$outgoingEdgesArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "findMany"> | Null>;
    incomingEdges<T extends Note$incomingEdgesArgs<ExtArgs> = {}>(
      args?: Subset<T, Note$incomingEdgesArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "findMany"> | Null>;
    /**
   ...
   * Note.outgoingEdges
   */
  export type Note$outgoingEdgesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   * Note.incomingEdges
   */
  export type Note$incomingEdgesArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Edge
  ...
  export type EdgeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetSelect<
      {
        id?: boolean;
        sourceId?: boolean;
  ...
  type EdgeGetPayload<S extends boolean | null | undefined | EdgeDefaultArgs> = $Result.GetResult<
    Prisma.$EdgePayload,
    S
  >;

  type EdgeCountArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = Omit<
    EdgeFindManyArgs,
    "select" | "include" | "distinct"
  > & {
  ...
  > {
    ...
    findUnique<T extends EdgeFindUniqueArgs>(
      ...
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "findUnique"> | null,
      null,
      ExtArgs
    >;
    ...
    findUniqueOrThrow<T extends EdgeFindUniqueOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "findUniqueOrThrow">,
      never,
      ExtArgs
    >;
    ...
    findFirst<T extends EdgeFindFirstArgs>(
      ...
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "findFirst"> | null,
      null,
      ExtArgs
    >;
    ...
    findFirstOrThrow<T extends EdgeFindFirstOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "findFirstOrThrow">,
      never,
      ExtArgs
    >;
    ...
    create<T extends EdgeCreateArgs>(
      ...
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "create">,
      never,
      ExtArgs
    >;
    ...
    createManyAndReturn<T extends EdgeCreateManyAndReturnArgs>(
      args?: SelectSubset<T, EdgeCreateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "createManyAndReturn">
    >;
    ...
    delete<T extends EdgeDeleteArgs>(
      ...
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "delete">,
      never,
      ExtArgs
    >;
    ...
    update<T extends EdgeUpdateArgs>(
      ...
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "update">,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends EdgeUpsertArgs>(
      ...
      $Result.GetResult<Prisma.$EdgePayload<ExtArgs>, T, "upsert">,
      never,
      ExtArgs
    >;
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise";
    source<T extends NoteDefaultArgs<ExtArgs> = {}>(
      args?: Subset<T, NoteDefaultArgs<ExtArgs>>
    ): Prisma__NoteClient<
      $Result.GetResult<Prisma.$NotePayload<ExtArgs>, T, "findUniqueOrThrow"> | Null,
      Null,
      ExtArgs
    >;
    target<T extends NoteDefaultArgs<ExtArgs> = {}>(
      args?: Subset<T, NoteDefaultArgs<ExtArgs>>
    ): Prisma__NoteClient<
      $Result.GetResult<Prisma.$NotePayload<ExtArgs>, T, "findUniqueOrThrow"> | Null,
      Null,
  ...
  > {
    ...
    findUnique<T extends UserSubscriptionFindUniqueArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "findUnique"> | null,
      null,
      ExtArgs
    >;
    ...
    findUniqueOrThrow<T extends UserSubscriptionFindUniqueOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "findUniqueOrThrow">,
      never,
      ExtArgs
    >;
    ...
    findFirst<T extends UserSubscriptionFindFirstArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "findFirst"> | null,
      null,
      ExtArgs
    >;
    ...
    findFirstOrThrow<T extends UserSubscriptionFindFirstOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "findFirstOrThrow">,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends UserSubscriptionFindManyArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "findMany">
    >;
    ...
    create<T extends UserSubscriptionCreateArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "create">,
      never,
      ExtArgs
    >;
    ...
    createManyAndReturn<T extends UserSubscriptionCreateManyAndReturnArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "createManyAndReturn">
    >;
    ...
    delete<T extends UserSubscriptionDeleteArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "delete">,
      never,
      ExtArgs
    >;
    ...
    update<T extends UserSubscriptionUpdateArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "update">,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends UserSubscriptionUpsertArgs>(
      ...
      $Result.GetResult<Prisma.$UserSubscriptionPayload<ExtArgs>, T, "upsert">,
      never,
      ExtArgs
    >;
    ...
    >(
      args: SubsetIntersection<T, UserSubscriptionGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
  ...
  export type UserSubscriptionOrderByWithRelationInput = {
    ...
    tier?: SortOrder;
    noteCount?: SortOrder;
    maxNotes?: SortOrderInput | SortOrder;
    aiEnabled?: SortOrder;
    createdAt?: SortOrder;
    updatedAt?: SortOrder;
  };
  ...
  export type EdgeCreateNestedManyWithoutSourceInput = {
    create?:
      | XOR<EdgeCreateWithoutSourceInput, EdgeUncheckedCreateWithoutSourceInput>
      | EdgeCreateWithoutSourceInput[]
      | EdgeUncheckedCreateWithoutSourceInput[];
    connectOrCreate?:
      | EdgeCreateOrConnectWithoutSourceInput
      | EdgeCreateOrConnectWithoutSourceInput[];
  ...
  export type EdgeCreateNestedManyWithoutTargetInput = {
    create?:
      | XOR<EdgeCreateWithoutTargetInput, EdgeUncheckedCreateWithoutTargetInput>
      | EdgeCreateWithoutTargetInput[]
      | EdgeUncheckedCreateWithoutTargetInput[];
    connectOrCreate?:
      | EdgeCreateOrConnectWithoutTargetInput
      | EdgeCreateOrConnectWithoutTargetInput[];
  ...
  export type EdgeUpdateManyWithoutSourceNestedInput = {
    ...
    connectOrCreate?:
      ...
      | EdgeCreateOrConnectWithoutSourceInput[];
    upsert?:
      | EdgeUpsertWithWhereUniqueWithoutSourceInput
      | EdgeUpsertWithWhereUniqueWithoutSourceInput[];
    createMany?: EdgeCreateManySourceInputEnvelope;
    ...
    connect?: EdgeWhereUniqueInput | EdgeWhereUniqueInput[];
    update?:
      | EdgeUpdateWithWhereUniqueWithoutSourceInput
      | EdgeUpdateWithWhereUniqueWithoutSourceInput[];
    updateMany?:
      | EdgeUpdateManyWithWhereWithoutSourceInput
      | EdgeUpdateManyWithWhereWithoutSourceInput[];
  ...
  export type EdgeUpdateManyWithoutTargetNestedInput = {
    ...
    connectOrCreate?:
      ...
      | EdgeCreateOrConnectWithoutTargetInput[];
    upsert?:
      | EdgeUpsertWithWhereUniqueWithoutTargetInput
      | EdgeUpsertWithWhereUniqueWithoutTargetInput[];
    createMany?: EdgeCreateManyTargetInputEnvelope;
    set?: EdgeWhereUniqueInput | EdgeWhereUniqueInput[];
    disconnect?: EdgeWhereUniqueInput | EdgeWhereUniqueInput[];
    ...
    connect?: EdgeWhereUniqueInput | EdgeWhereUniqueInput[];
    update?:
      | EdgeUpdateWithWhereUniqueWithoutTargetInput
      | EdgeUpdateWithWhereUniqueWithoutTargetInput[];
    updateMany?:
      | EdgeUpdateManyWithWhereWithoutTargetInput
      | EdgeUpdateManyWithWhereWithoutTargetInput[];
    deleteMany?: EdgeScalarWhereInput | EdgeScalarWhereInput[];
  };
  ...
  export type NoteUpdateOneRequiredWithoutOutgoingEdgesNestedInput = {
    ...
    connect?: NoteWhereUniqueInput;
    update?: XOR<
      XOR<NoteUpdateToOneWithWhereWithoutOutgoingEdgesInput, NoteUpdateWithoutOutgoingEdgesInput>,
      NoteUncheckedUpdateWithoutOutgoingEdgesInput
    >;
  };
  ...
  export type NoteUpdateOneRequiredWithoutIncomingEdgesNestedInput = {
    ...
    connect?: NoteWhereUniqueInput;
    update?: XOR<
      XOR<NoteUpdateToOneWithWhereWithoutIncomingEdgesInput, NoteUpdateWithoutIncomingEdgesInput>,
      NoteUncheckedUpdateWithoutIncomingEdgesInput
    >;
  };
  ...
  export type NoteCountOutputTypeArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = NoteCountOutputTypeDefaultArgs<ExtArgs>;
  /**
   * @deprecated Use NoteDefaultArgs instead
   */
  export type NoteArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    NoteDefaultArgs<ExtArgs>;
  /**
   * @deprecated Use EdgeDefaultArgs instead
   */
  export type EdgeArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    EdgeDefaultArgs<ExtArgs>;
  /**
   * @deprecated Use UserSubscriptionDefaultArgs instead
   */
  export type UserSubscriptionArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = UserSubscriptionDefaultArgs<ExtArgs>;
